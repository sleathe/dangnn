...
func (c *Clique) VerifyHeader(chain consensus.ChainReader, header *types.Header, seal bool, checkMiner bool) error {
...
func (c *Clique) VerifyHeaders(chain consensus.ChainReader, headers []*types.Header, seals []bool, checkMiner bool) (chan<- struct{}, <-chan error) {
