...
var (
	...
	MainnetGenesisHash = common.HexToHash("0xa979a9020bf4bf1d8e07242fe2877202bc2125cc9b10976d4c3dc9bf1e185945")
	TestnetGenesisHash = common.HexToHash("0xec759f17b70ff944188952b3d6253997bdfb285dd6fcacac267b579352a4f862")
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		CarrotBlock:		 big.NewInt(1000000),
	...
	AllEthashProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil, new(EthashConfig), nil}
	...
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllCliqueProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil, &CliqueConfig{Period: 0, Epoch: 30000}}
...
type ChainConfig struct {
	...
	CarrotBlock			*big.Int `json:"carrotBlock,omitempty"`    // Carrot switch block (nil = no fork, 0 = already activated)
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Byzantium: %v Constantinople: %v Petersburg: %v Istanbul: %v, Muir Glacier: %v, Carrot: %v, Engine: %v}",
		c.ChainID,
		c.HomesteadBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,
...
func (c *ChainConfig) IsCarrot(num *big.Int) bool {
	return isForked(c.CarrotBlock, num)
}
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, head *big.Int) *ConfigCompatError {
	...
	if isForkIncompatible(c.CarrotBlock, newcfg.CarrotBlock, head) {
		return newCompatError("carrot fork block", c.CarrotBlock, newcfg.CarrotBlock)
	}
	return nil
}
