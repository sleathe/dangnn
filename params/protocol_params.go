...
const (
	...
	MinerDiscardGas     uint64 = 0    // Price for Miner Discard
...
var (
	...
	GenesisDifficulty      = big.NewInt(2097152) // Difficulty of the Genesis block.
	MinimumDifficulty      = big.NewInt(2097152) // The minimum that the difficulty may ever be.
